...
<tags:pageTemplate titulo="${produto.titulo }">
	...
	<article id="${produto.id} " itemscope> 
		...
		<section class="buy-options clearfix">
			<form:form action="${contextPath}carrinho/add" method="post" cssClass="container"> <!-- servletRelativeAction= -->
				<input type="hidden" value="${produto.id }" name="produtoId" >
				<ul id="variants" class="clearfix">
					<c:forEach items="${produto.precos }" var="preco">
						<li class="buy-option">
							<input type="radio" name="tipoPreco" class="variant-radio" id="tipoPreco" value="${preco.tipo }" checked="checked" />  <!-- name="id" id="tipoPreco" -->
